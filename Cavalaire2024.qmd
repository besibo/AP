...
autres <- tribble(
 ~Qui,  ~Logement, ~Nourriture, ~Carburant, ~Peages, ~Navette, ~Diver,
  ...
  "nat" ,  0,  258.01+32.31,  78.18+96+68.71,  51.8+4+24.1+4.4+6.4,  0,  0,
  "Ped" ,  0,  142.59+22+11.9+7.22+100,  100,  34.1+4.9+11.20,  0,  0,
...
Nous avons logé au [690, avenue de la Castillane](https://www.google.fr/maps/place/690+Av.+de+la+Castillane,+83240+Cavalaire-sur-Mer/@43.1799155,6.5186244,17z/data=!3m1!4b1!4m6!3m5!1s0x12cec) ([Description de la location sur Le Bon Coin](https://www.leboncoin.fr/locations_saisonnieres/1489618857.htm)). Maison très sympa avec piscine (pas chaude, mais pratique pour repérer les fuites dans les combis étanches...), terrasse, gazon synthétique, et une grande allée en pente pour garer jusqu'à 4 véhicules. À environ 5 minutes du port de Cavalaire. Il y a 2 chambres doubles avec SDB au RDC. Possibilité de mettre un matelas dans chaque chambre. À l'étage, une chambre double et un "dortoir" avec jusqu'à 4 places (3 personnes idéalement). Pièce de vie agréable et location bon marché : une bonne adresse à conserver.

Comme d'habitude, les remorques (bateau et compresseurs) sont restées sur le port toute la semaine. Côté plongées, c'est plutôt pas mal en dépit d'une météo (très) pénible. Beaucoup (BEAUCOUP) de vent. Nous avons été tranquilles le dimanche et le vendredi matin. Le reste du temps, vent très violent en rafales (jusqu'à 150 km/h enregistrés dans le Var), d'où les plongées répétées sur le Ramon Membru et dans la Calanque de la Cron (sables et posidonies dans 10 mètres d'eau à peine...). La visi était globalement moyenne (assez laiteuse la plupart du temps), mais nous avons quand même vu de belles choses : banc de sérioles, Saint Pierre, baracuda solitaire, sèche, poulpes, homards, mérous, dorades... et même un espadon a été aperçu en surface.
