...
## Dive sites
sites <- c(	"Kleber", NA, # Dimanche
			      NA, "Swansea Vale", # Lundi
			      NA, NA, # Mardi
			      NA, NA, # Mercredi
			      NA, NA, # Jeudi
			      NA, NA) # vendredi
...
`Plongée 01` = c(  1,   1,   1,   1,   0,   0,   0,   0,   0),
`Plongée 02` = c(  0,   0,   0,   0,   0,   0,   0,   0,   0),
`Plongée 03` = c(  1,   0,   0,   1,   1,   0,   0,   0,   0),
`Plongée 04` = c(  0,   0,   0,   0,   0,   0,   0,   0,   0),
`Plongée 05` = c(  0,   0,   0,   0,   0,   0,   0,   0,   0),
...
autres <- tribble(
 ~Qui,  ~Logement, ~Nourriture, ~Carburant, ~Peages, ~Navette, ~Diver,
  ...
  "cal" ,  159,  0,  0,  0,  0,  0,
  "car" ,  159,  0,  0,  0,  0,  0,
  "grom",  159*2,  0,  0,  0,  0,  0,
  "nat" ,  159,  349.50,  0,  0,  0,  0,
  "Ped" ,  159*2,  0,  0,  0,  0,  0,
  "tho" ,  159,  0,  0,  0,  0,  0,
  "bea" ,  200,  0,  0,  0,  0,  0)
```
