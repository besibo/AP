...
subtitle: |
  ...
  |
  | *Citation rigolote* --- Auteur, 18 juillet.
date: now
...
sites <- c(	"Kleber", "Vorpostenboot", # Dimanche
			      "V mes couilles et recherche bloc", NA, # Lundi
...
autres <- tribble(
 ~Qui,  ~Logement, ~Nourriture, ~Carburant, ~Peages, ~Navette, ~Diver,
  "bap" ,  0,  0,  108.33,  0,  0,  0,
  "beu" ,  273.62,  133.85,  0,  0,  0,  0,
  "cal" ,  159,  0,  102.69,  0,  0,  0,
  "car" ,  159,  0,  40.36,  0,  0,  0,
  "grom",  159*2,  35+42.15,  0,  0,  0,  0,
  "nat" ,  159,  349.50+7.99+7.1+25.8+8.49,  0,  0,  0,  0,
  "Ped" ,  159*2,  40.74+8.1+8+12.56+38+24,  0,  0,  0,  0,
